...
function App() {
  ...
  return (
    <div>
      ...
      <div>
        <SearchResultsPage category={category} addToCart={addToCart} discount={discount} subtotal={subtotal} />
        <CheckoutPage cart={cart} removeFromCart={removeFromCart} subtotal={subtotal} discount={discount} total={total} />
      </div>
    </div>
  );
}
